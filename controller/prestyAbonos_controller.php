<?php
require_once 'model/prestyAbonos.php';
class prestyAbonos_controller
{
  private $model;
  public function __construct()
  {
    $this->model = new prestyAbonos();
  }
  public function indexPrestyAbonos()
  {
    require_once 'view/prestyAbonos.php';
  }
  public function showById()
  {
    $animal=new prestyAbonos();
